...
This project is a minecraft clone (voxel engine) that works on both Windows and on Raspberry Pi4.
...
Everything in SharedItems (/Common/SharedItems) is created by Kevin Pladdet, except for miniaudio.h and FastNoiseLite.h
